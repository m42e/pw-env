...
pub use crate::file_io::{
    atomic_write_file, create_private_temp_file, replace_file_atomically, write_private_file,
};
...
"#;
    ...
    fn temporary_file_creation_propagates_non_collision_errors() {
        ...
        let error = crate::file_io::create_temporary_file_with_nonce(&path, false, 12345)
            .unwrap_err()
            .to_string();
